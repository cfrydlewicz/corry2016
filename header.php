		...
		<div class="u-inner u-inner--padded shadowed wire-outline">
			<div class="header-logo wire-outline">
				<a href="/" title="Go to the homepage.">
					...
					<img alt="Site logo. Click to go to the homepage." src="<?php bloginfo('template_url');?>/images/logo-header.png" />
					<div class="logo-glitch logo-glitch--1"></div>
					<div class="logo-glitch logo-glitch--2"></div>
				</a>
			</div>
